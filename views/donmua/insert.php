        ...
        <FIELDSET style="border-collapse: collapse;border: 1px solid red" class="mt-5 ml-5 mr-5">
            ...
            <div class="form-row ml-4">
                ...
                <div class="col-md-3 form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="gia" name="gia" oninput="formatCurrency(this)" placeholder="Giá">
                </div>
                <div class="col-md-3 form-group mb-3">
...
//    echo  number_format($tongdon,0,".",",");
    ...
    $idDonMua = DonMua::add($ngaynhap, $nhanvien, $nhacungcap, $tongdon, $trangthai);
