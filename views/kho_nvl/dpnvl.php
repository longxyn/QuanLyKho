...
<form onsubmit="return validateForm();" method="post" action="">
    <div class="form-group ml-5">
        <div class="col-md-4 mb-3">
            ...
            <input readonly  type="text" class="form-control" id="validationDefault01" value="<?= $nvl->TenNVL ?>" name="TenNVL" placeholder="Tên Sản Phẩm" required>
        </div>
        <div class="col-md-4 mb-3">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input hidden type="number" class="form-control" id="validationDefault02"
             value="<?= $nvl->SoLuong ?>" name="soluong" placeholder="Nhập số lượng" required>
